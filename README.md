...
> 기간: 2023.08   
> 기존 게이미피케이션 통합 어드민 페이지에 신규 기능 및 개편을 지원했습니다.
> - [연속된 이벤트 참여 일자 집계 처리 프로시저]()
> 
> 
> ### 밀크티 고등 선생님 홈 신규 개편
> 기간: 2023.05
> 기존 고등 선생님 홈을 모두 새롭게 구축했습니다.   
...
>
> 일부 신규 페이지에 Vue.js를 이용한 구현을 요청받아, 반영했습니다.   
> 뷰 객체, 태그들의 비동기적으로 렌더링을 임의의 순서대로 순차적으로 렌더링하도록 돕는 js 모듈을 개발 적용했습니다.   
> - [fnMaestro]()
> 
## 천재교과서 중고영업개발팀
> 기간: 2021.01 ~ 2022.10    
...
> 여러 경로와 복수의 리소스 제공자(DB)를 사용자 입력으로, 동적 라우팅 지원   
> [API_Repository_GitHub](https://github.com/Iol-lshh/api-repository)   
    
   
### SpringMVC JPA 이용한, 게시글 REST API
> 기간: 2022.06   
> SpringBoot + JPA   
> [forum_SpringMVC_GitHub](https://github.com/Iol-lshh/forum_SpringMVC)   
